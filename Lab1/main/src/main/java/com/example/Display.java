...
public class Display {
    ...
    private boolean isSameSize(Display m) {
        return this.area() == m.area();
    }
    ...
    private boolean isSameSharpness(Display m) {
        return this.ppi == m.ppi;
    }
    ...
    public static void main(String[] args) {
        ...
        displayDescription(descriptions, scan);
        displayComparation(descriptions);
        scan.close();
    }

    static void displayDescription(Display[] descriptions, Scanner scan) {
    ...
    static void displayComparation(Display[] descriptions) {
        for (int i = 0; i < descriptions.length; i++) {
